...
var ke = a((_ref4, _) => {
  ...
  var B = s(() => e.Children.toArray(o).filter(e.isValidElement), [o]),
    R = r(e => {
      ...
      var t = (_C$current = C.current) == null ? void 0 : _C$current[e];
  ...
  return u(_, () => ({
    ...
    var t = _extends({
      ...
      descriptor: {
        ...
        views: p.map((e, t) => {
          ...
          var i = V.current.get(x.current[t]),
    ...
    O.current = new Ne(I.current, t, b, w, S), O.current.on("sashDragStart", () => {
      ...
      if (z && O.current) {
        ...
        for (var _t19 = 0; _t19 < _e24.length; _t19++) {
          var _i13 = V.current.get(_e24[_t19]);
          void 0 !== (_i13 == null ? void 0 : _i13.visible) && _i13.visible !== O.current.isViewVisible(_t19) && z(_t19, O.current.isViewVisible(_t19));
        }
      }
    ...
    if (F) {
      var _e25 = B.map(e => e.key),
        _t20 = [...x.current],
        _i14 = _e25.filter(e => !x.current.includes(e)),
        _n7 = _e25.filter(e => x.current.includes(e)),
        _r4 = x.current.map(t => !_e25.includes(t));
      for (var _e26 = _r4.length - 1; _e26 >= 0; _e26--) {
        var _O$current5;
        _r4[_e26] && ((_O$current5 = O.current) != null && _O$current5.removeView(_e26), _t20.splice(_e26, 1), C.current.splice(_e26, 1));
      }
      var _loop = function _loop(_n8) {
        var _i$minSize2, _i$maxSize2, _i$priority2, _i$snap2, _O$current7;
        var i = V.current.get(_n8),
          r = new Te(T.current, _extends({
            element: document.createElement("div"),
        ...
        (_O$current7 = O.current) != null && _O$current7.addView(N.current.get(_n8), r, Ee.Distribute, _e25.findIndex(e => e === _n8)), _t20.splice(_e25.findIndex(e => e === _n8), 0, _n8), C.current.splice(_e25.findIndex(e => e === _n8), 0, r);
      };
      for (var _n8 of _i14) {
        _loop(_n8);
      }
      ...
      var _loop3 = function _loop3(_t21) {
        ...
        var i = _e25.findIndex(e => e === _t21),
          n = C.current[i].preferredSize;
        void 0 !== n && ((_O$current8 = O.current) == null ? void 0 : _O$current8.resizeView(i, n));
      };
      ...
      var _loop4 = function _loop4(_t22) {
        ...
        var i = V.current.get(_t22),
          n = _e25.findIndex(e => e === _t22);
        i && Ce(i) && void 0 !== i.visible && ((_O$current9 = O.current) == null ? void 0 : _O$current9.isViewVisible(n)) !== i.visible && ((_O$current10 = O.current) == null ? void 0 : _O$current10.setViewVisible(n, i.visible));
      };
      for (var _t22 of [..._i14, ..._n7]) {
        _loop4(_t22);
      }
      var _loop5 = function _loop5(_t23) {
        var i = V.current.get(_t23),
          n = _e25.findIndex(e => e === _t23);
        if (i && Ce(i)) {
          var _O$current11;
          void 0 !== i.preferredSize && C.current[n].preferredSize !== i.preferredSize && (C.current[n].preferredSize = i.preferredSize);
          var _e27 = !1;
          void 0 !== i.minSize && C.current[n].minimumSize !== i.minSize && (C.current[n].minimumSize = i.minSize, _e27 = !0), void 0 !== i.maxSize && C.current[n].maximumSize !== i.maxSize && (C.current[n].maximumSize = i.maxSize, _e27 = !0), _e27 && ((_O$current11 = O.current) == null ? void 0 : _O$current11.layout());
        }
      };
      for (var _t23 of _n7) {
        _loop5(_t23);
      }
      (_i14.length > 0 || _r4.length > 0) && (x.current = _e25);
    }
  }, [B, F, c, h, v]), n(() => {
    ...
    if (!F) {
      ...
      (_O$current13 = O.current) != null && _O$current13.layout(y ? _e28 : _t24), T.current.setSize(y ? _e28 : _t24), $(!0);
    }
  }, [F, y]), n(() => {
    k && $e(20);
  }, []), e.createElement("div", {
