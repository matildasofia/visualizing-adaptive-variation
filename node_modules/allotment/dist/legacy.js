  ...
  _createClass(Ie, [{
    ...
    value: function layout() {
      ...
      if (this.size = e, this.proportions) for (var _t4 = 0; _t4 < this.viewItems.length; _t4++) {
        ...
        _i4.size = v(Math.round(this.proportions[_t4] * e), _i4.minimumSize, _i4.maximumSize);
      } else {
    ...
    value: function resizeViews(e) {
      for (var _t5 = 0; _t5 < e.length; _t5++) {
        ...
        var _n4 = e[_t5];
        _n4 = Math.round(_n4), _n4 = v(_n4, _i6.minimumSize, Math.min(_i6.maximumSize, this.size)), _i6.size = _n4;
      }
    ...
    value: function resize(e, t) {
      ...
      for (var _e14 = 0, _i12 = t = v(t, z, w); _e14 < l.length; _e14++) {
        var _t9 = l[_e14],
          _n5 = v(f[_e14] + _i12, _t9.minimumSize, _t9.maximumSize);
        _i12 -= _n5 - f[_e14], _t9.size = _n5;
      }
      for (var _e15 = 0, _i13 = t; _e15 < m.length; _e15++) {
        var _t10 = m[_e15],
          _n6 = v(d[_e15] - _i13, _t10.minimumSize, _t10.maximumSize);
        _i13 += _n6 - d[_e15], _t10.size = _n6;
      }
      return t;
    }
  }, {
    ...
    value: function distributeEmptySpace(e) {
      ...
      for (var _e16 = 0; 0 !== i && _e16 < n.length; _e16++) {
        var _t11 = this.viewItems[n[_e16]],
          _s4 = v(_t11.size + i, _t11.minimumSize, _t11.maximumSize);
    ...
    value: function updateSashEnablement() {
      ...
      for (var _e17 = 0; _e17 < this.sashItems.length; _e17++) {
        ...
        if (_a && _u) {
          var _i14 = k(_e17, -1, -1),
            _r2 = k(_e17 + 1, this.viewItems.length),
          ...
          _c && s[_e17] && (o > 0 || this.startSnappingEnabled) ? _n7.state = de.Minimum : _h && t[_e17] && (o < this.contentSize || this.endSnappingEnabled) ? _n7.state = de.Maximum : _n7.state = de.Disabled;
        } else _n7.state = _a && !_u ? de.Minimum : !_a && _u ? de.Maximum : de.Enabled;
      }
    }
  }, {
...
var De = e.forwardRef(function (_ref4, y) {
  ...
  var T = e.useMemo(function () {
    ...
    F = e.useCallback(function (e) {
      var _N$current, _j$current;
      var t = (_N$current = N.current) === null || _N$current === void 0 ? void 0 : _N$current[e];
  ...
  return e.useImperativeHandle(y, function () {
    ...
    var e = !0;
    c && L.current.size !== c.length && (e = !1, console.warn("Expected ".concat(c.length, " children based on defaultSizes but found ").concat(L.current.size))), e && c && (S.current = T.map(function (e) {
      return e.key;
    }));
    var t = _objectSpread({
      orientation: l ? me.Vertical : me.Horizontal,
      ...
      descriptor: {
        ...
        views: c.map(function (e, t) {
          ...
          var i = I.current.get(S.current[t]),
            r = new je(O.current, _objectSpread(_objectSpread({
    ...
    j.current = new Ie(g.current, t, f, p, v), j.current.on("sashDragStart", function () {
      var _g$current;
      (_g$current = g.current) === null || _g$current === void 0 ? void 0 : _g$current.classList.add("split-view-sash-dragging");
    }), j.current.on("sashDragEnd", function () {
      var _g$current2;
      (_g$current2 = g.current) === null || _g$current2 === void 0 ? void 0 : _g$current2.classList.remove("split-view-sash-dragging");
      ...
      if (d && j.current) {
        ...
        for (var _t19 = 0; _t19 < _e25.length; _t19++) {
          var _i15 = I.current.get(_e25[_t19]);
    ...
    if (A) {
      var _e26 = T.map(function (e) {
        ...
        _t20 = _toConsumableArray(S.current),
        _i16 = _e26.filter(function (e) {
          return !S.current.includes(e);
        }),
        _r3 = _e26.filter(function (e) {
          return S.current.includes(e);
        }),
        _o = S.current.map(function (t) {
          return !_e26.includes(t);
        });
      for (var _e27 = _o.length - 1; _e27 >= 0; _e27--) {
        var _j$current5;
        _o[_e27] && ((_j$current5 = j.current) !== null && _j$current5 !== void 0 && _j$current5.removeView(_e27), _t20.splice(_e27, 1), N.current.splice(_e27, 1));
      }
      ...
      try {
        var _loop3 = function _loop3() {
          ...
          var r = _step9.value;
          var i = I.current.get(r),
            o = new je(O.current, _objectSpread(_objectSpread({
              element: document.createElement("div"),
          ...
          (_j$current9 = j.current) !== null && _j$current9 !== void 0 && _j$current9.addView(L.current.get(r), o, be.Distribute, _e26.findIndex(function (e) {
            return e === r;
          })), _t20.splice(_e26.findIndex(function (e) {
            return e === r;
          }), 0, r), N.current.splice(_e26.findIndex(function (e) {
            return e === r;
          }), 0, o);
        };
      ...
      for (; !b(_e26, _t20);) {
        ...
        try {
          var _loop = function _loop() {
            ...
            if (e !== i) {
              var _j$current6;
              (_j$current6 = j.current) === null || _j$current6 === void 0 ? void 0 : _j$current6.moveView(L.current.get(n), e, i);
              var _s5 = _t20[e];
      ...
      var _loop2 = function _loop2() {
        ...
        i && Le(i) && void 0 !== i.visible && ((_j$current7 = j.current) === null || _j$current7 === void 0 ? void 0 : _j$current7.isViewVisible(n)) !== i.visible && ((_j$current8 = j.current) === null || _j$current8 === void 0 ? void 0 : _j$current8.setViewVisible(n, i.visible));
      };
      ...
      try {
        var _loop5 = function _loop5() {
          ...
          if (i && Le(i)) {
            var _j$current11;
            void 0 !== i.preferredSize && N.current[n].preferredSize !== i.preferredSize && (N.current[n].preferredSize = i.preferredSize);
            var _e28 = !1;
            void 0 !== i.minSize && N.current[n].minimumSize !== i.minSize && (N.current[n].minimumSize = i.minSize, _e28 = !0), void 0 !== i.maxSize && N.current[n].maximumSize !== i.maxSize && (N.current[n].maximumSize = i.maxSize, _e28 = !0), _e28 && ((_j$current11 = j.current) === null || _j$current11 === void 0 ? void 0 : _j$current11.layout());
          }
        };
      ...
      (_i16.length > 0 || _o.length > 0) && (S.current = _e26);
    }
    ...
    j.current && (j.current.onDidDragEnd = v);
  }, [v]), z({
    ref: g,
    ...
    if (!A) {
      var _j$current13;
      var _g$current$getBoundin = g.current.getBoundingClientRect(),
        _e29 = _g$current$getBoundin.height,
        _t21 = _g$current$getBoundin.width;
    ...
    }, w, l ? x : E, _defineProperty({}, V, a), i)
  }, e.createElement("div", {
    className: r("split-view-container", _)
  }, e.Children.toArray(t).map(function (t) {
    if (!e.isValidElement(t)) return null;
    var i = t.key;
    return "Allotment.Pane" === t.type.displayName ? (I.current.set(i, t.props), e.cloneElement(t, {
      key: i,
      ref: function ref(e) {
        var n = t.ref;
